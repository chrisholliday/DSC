...
'@
    ...
    Node "localhost" {
        ...
        # Note - 'NT VIRTUAL MACHINE\Virtual Machines' is only available on Hyper-v servers. We can not set this via DSC
        # because Azure Automation DSC does not know about the domain 'NT Virtual Machine'. Excluding that vaule.
        UserRightsAssignment Createsymboliclinks {
            Policy   = 'Create_symbolic_links'
            Identity = 'Administrators'
        }
        ...
        #  FIX - Not applied for for non-domain joined Computer
        ...
        SecurityOption AccountSecurityOptions {
            ...
            # Per Compliance check, this is not a vaild control. May need to implement another way.
