<#
 Configuration Definition for non-domain joined Windows Server 2019, based on CIS benchmark
 As a result, controls that prevent the use of local accounts or required Domain have been disabled
 Domain Controller specific controls are disabled but included

Easily find disabled settings by searching for the word FIX

 Based on the CIS_WindowsServer2019_v110 file from # https://github.com/NVISO-BE/posh-dsc-windows-hardening

#>

Configuration cis_mma {
    ...
    $WarningText = @'
WARNING! Unauthorized access is strictly forbidden.
'@

    Node "localhost" {

        # Firewall Configuration - Set network interface to Private Profile (default is public)
        ...
        SecurityOption AccountSecurityOptions {
            ...
            Interactive_logon_Message_text_for_users_attempting_to_log_on                                                   = $WarningText
