...
# Contact Christopher.Holliday@frit.frb.org for any questions or problems

Configuration FRS_Win19_GI_v1 {
...
'@
    ...
    Node "localhost" {
        ...
        SecurityOption AccountSecurityOptions {
            ...
            # For the Gold Image, Disabling this control as Sysprep will re-enable it.
