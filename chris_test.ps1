...
Configuration chris_test {
    ...
    # Define Access to the Log Analytics Workspace
    $OPSINSIGHTS_WS_ID = "4114ec1e-b14c-438f-ad41-99d9d321d10a"
    $OPSINSIGHTS_WS_KEY = "SQwFtQWGUh/fkDxUemuK+ToeWxP49Hr+1swmRGDrrfE+tQutqLbiHiJuNSOz+7umSD1EgJAKRaGagXOR55qbCA=="

    $FRSLegalNotice = @'
WARNING! If you are not authorized to use this private network, please disconnect immediately. Unauthorized access is prohibited and may result in civil and/or criminal prosecution. 
Users expressly consent to having their activities monitored, recorded, and shared with third parties. By your continued use of this network, you acknowledge that you have read, understood, and agree with this warning message.
'@

    Node "localhost" {


        # Firewall Configuration - SET Interface to Private Profile (default is public)
        ...
        # Configure Log Analytic Management Agent
        # Source https://docs.microsoft.com/en-us/azure/azure-monitor/platform/agent-windows
        Service OIService {
            Name      = "HealthService"
            State     = "Running"
            DependsOn = "[Package]OI"
        }
        <#  We will be staging this file locally rather than pulling it down from the internet.
...
#>
        ...
        # Enable Remote Desktop Capability
        ...
        # Microsoft Security Center Security Recomendations

        # Block outdated ActiveX controls for Internet Explorer
        Registry 'OutdatedActiveX' {
            Ensure    = 'Present'
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Ext'
        ...
        # CAP03.190 TLS 1.1 is expected to be Deprecated or Restricted after 2020.
        Registry 'TLSClientEnabled11' {
            Ensure    = 'Present'
        ...
        # CAP03.200 Use of TLS 1.0 is restricted.
        Registry 'TLSClientEnabled10' {
            Ensure    = 'Present'
        ...
        <#
        # CAP03.170 TLS 1.2 CipherSuite 
        Registry 'TLSServerDefault12' {
            Ensure    = 'Present'
            Key       = 'HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\server'
            ValueName = 'DisabledbyDefault'
            ValueType = 'DWord'
        ...
        #  2.2.2 (L1) (DC Only) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users, ENTERPRISE DOMAIN CONTROLLERS' (DC only)
        # UserRightsAssignment Accessthiscomputerfromthenetwork {
        #    Policy   = 'Access_this_computer_from_the_network'
        #    Identity = 'Administrators, '
        #}

        #  2.2.3 (L1) (MS) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users' (MS only)
        UserRightsAssignment Accessthiscomputerfromthenetwork {
            Policy   = 'Access_this_computer_from_the_network'
        ...
        #  FIX - Removing 'Local Account' and 'Administrators' as we can only access the computer using local admin accounts.
        ...
        #  Caution: Configuring a standalone (non-domain-joined) server as described above may result in an inability to remotely administer the server
        #  FIX:  'Local Account' if added prevents the use of Remote Desktop Services for non-domain joined servers. Removing 'Local Account' from control
        UserRightsAssignment DenylogonthroughRemoteDesktopServices {
            Policy   = 'Deny_log_on_through_Remote_Desktop_Services'
            Identity = 'Guests'
        }
        ...
        UserRightsAssignment Impersonateaclientafterauthentication {
            Policy   = 'Impersonate_a_client_after_authentication'
            Identity = 'Administrators', 'LOCAL SERVICE', 'NETWORK SERVICE', 'SERVICE', 'IIS_IUSRS'
        }
        ...
        SecurityOption AccountSecurityOptions {
            ...
            # FIX: This will break non-domain computers, removing from control
            ...
            Accounts_Rename_administrator_account                                                                           = 'Executive' # WARNING! Any value different from Administrator
            
            # 2.3.1.6 (L1) Configure 'Accounts: Rename guest account'
            Accounts_Rename_guest_account                                                                                   = 'Unwanted' # WARNING! Any value different from Guest
            ...
            # Fix: Bypassing control as computer is not domain-joined
            ...
            Interactive_logon_Message_text_for_users_attempting_to_log_on                                                   = $FRSLegalNotice
            ...
            Network_access_Remotely_accessible_registry_paths                                                               = 'HKLM\System\CurrentControlSet\Control\ProductOptions,HKLM\System\CurrentControlSet\Control\Server Applications,HKLM\Software\Microsoft\Windows NT\CurrentVersion'
            
            # 2.3.10.9 (L1) Configure 'Network access: Remotely accessible registry paths and sub-paths' 
            Network_access_Remotely_accessible_registry_paths_and_subpaths                                                  = 'System\CurrentControlSet\Control\Print\Printers,System\CurrentControlSet\Services\Eventlog,Software\MicrosoftOLAP Server,Software\Microsoft\Windows NT\CurrentVersion\Print,Software\Microsoft\Windows NT\CurrentVersion\Windows,System\CurrentControlSet\Control\ContentIndex,System\CurrentControlSet\Control\Terminal Server,System\CurrentControlSet\Control\Terminal Server\UserConfig,System\CurrentControlSet\Control\Terminal Server\DefaultUserConfiguration,Software\Microsoft\Windows NT\CurrentVersion\Perflib,System\CurrentControlSet\Services\SysmonLog'
        ...
        # 17.2.2 (L1) Ensure 'Audit Computer Account Management' is set to 'Success and Failure' (DC Only)
        ...
        # 17.2.4 (L1) Ensure 'Audit Other Account Management Events' is set to 'Success and Failure' (DC only)
        ...
        #  18.1.2.1 (L1) Ensure 'Allow users to enable online speech recognition services' is set to 'Disabled' 
       ...
       #>
        ...
        #  Review
        Registry 'EncryptionOracleRemediation ' {
            Ensure    = 'Present'
        ...
        # FIX: This breaks Powershell DSC, setting it to enabled
